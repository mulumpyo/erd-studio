...
import {
  ExportSqlResponseDto,
  ImportSqlResponseDto,
...
export class SqlController {
  ...
  @ApiCreatedResponse({
    description: '만들어진 SQL을 `sql` 값으로 줘요.',
    type: ExportSqlResponseDto,
  })
  ...
  @ApiCreatedResponse({
    description: '읽어 들인 다이어그램을 `document` 값으로 줘요.',
    type: ImportSqlResponseDto,
  })
