...
export class AdminController {
  ...
  @ApiOkResponse({
    description: '관리자로 올린 계정이에요.',
    type: AdminPublicUserDto,
  })
  @ApiNotFoundResponse({
  ...
  @ApiOkResponse({
    description: '메일을 보냈어요. 서버에 메일 설정이 없으면 mailed가 false예요.',
