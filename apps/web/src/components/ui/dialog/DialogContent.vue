...
<template>
  <DialogPortal>
    ...
    <DialogContent
      :class="
        cn(
          'fixed left-1/2 top-1/2 flex w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden border-0 bg-card p-0 shadow-[0_16px_48px_rgb(28_25_23_/_0.16)] sm:rounded-[24px]',
